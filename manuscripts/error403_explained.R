# This is an explanation to an error I have encountered myself when trying to push for the first time
# error403 is related to credentials
# what to do (Mac users):
